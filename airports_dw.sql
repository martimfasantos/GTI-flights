...
CREATE TABLE fact_flight (
    ...
    FOREIGN KEY (AIRPORT_ORIG) REFERENCES dim_airport_orig (AIRPORT_ID),
    FOREIGN KEY (AIRPORT_DEST) REFERENCES dim_airport_dest (AIRPORT_ID),
    FOREIGN KEY (DEPARTURE) REFERENCES dim_time_dept (TIME_ID),
    FOREIGN KEY (ARRIVAL) REFERENCES dim_time_arrv (TIME_ID),
